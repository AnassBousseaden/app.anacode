...
class FileManager {
	constructor(languageInfo, executionContext) {
		this.languageInfo = languageInfo;
		this.problemData = executionContext;
		this.mainFileIndex = 0;
		this.solutionFileIndex = 1;
		this.fileCounter = 0;
		console.log('fileManager ExecutionContext:', executionContext);
		...
		console.log('filelist:', get(this.fileList));
	}
